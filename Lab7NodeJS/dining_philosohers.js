...
if (cluster.isMaster) {
    ...
    const philosophers = [
        new Philosopher('Judith Butler', 0, 1),
        new Philosopher('Gilles Deleuze', 1, 2),
        new Philosopher('Karl Marx', 2, 3),
        new Philosopher('Emma Goldman', 3, 4),
        new Philosopher('Michel Foucault', 0, 4),
    ]
